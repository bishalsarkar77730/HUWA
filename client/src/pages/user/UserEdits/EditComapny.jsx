...
const EditComapny = () => {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const currentcompany = await axios.get(`/company/${serialnum}`);
    try {
      let payload = {
        companyname:
        ...
        permonthSallary:
          permonthSallary === ""
            ? currentcompany.permonthSallary
            : permonthSallary,
        startingdate:
          startingdate === "" ? currentcompany.startingDate : startingdate,
        endingdate: endingdate === "" ? currentcompany.endingDate : endingdate,
      };
